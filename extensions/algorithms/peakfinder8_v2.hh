...
#ifndef PEAKFINDER8_V2_H
#define PEAKFINDER8_V2_H
...
void allocatePeakList_v2(tPeakList_v2* peak, long NpeaksMax);
void freePeakList_v2(tPeakList_v2 peak);

int peakfinder8_v2(tPeakList_v2* peaklist, float* data, char* mask, float* pix_radius,
