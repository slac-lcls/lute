...
def setup_smd2_env() -> None:
    ...
    os.environ["PS_SRV_NODES"] = str(srv_cores)
    os.environ["PS_EB_NODES"] = str(eb_cores)
    ...
    os.environ["PS_HOST_FILE"] = host_file
    os.environ["PS_N_RANKS"] = str(n_ranks)
